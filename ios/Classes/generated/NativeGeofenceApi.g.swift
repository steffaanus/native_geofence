...
struct GeofenceCallbackParams: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> GeofenceCallbackParams? {
    guard pigeonVar_list.count >= 4 else {
      print("Error: pigeonVar_list does not contain enough elements.")
      return nil
    }

    guard let geofences = pigeonVar_list[0] as? [ActiveGeofence?] else {
      print("Error: pigeonVar_list[0] is not of type [ActiveGeofence?]. Actual type: \(type(of: pigeonVar_list[0]))")
      return nil
    }

    guard let event = pigeonVar_list[1] as? GeofenceEvent else {
      print("Error: pigeonVar_list[1] is not of type GeofenceEvent.")
      return nil
    }

    let location: Location? = nilOrValue(pigeonVar_list[2])

    guard let callbackHandle = pigeonVar_list[3] as? Int64 else {
      print("Error: pigeonVar_list[3] is not of type Int64.")
      return nil
    }
